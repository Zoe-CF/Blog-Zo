...
var articleSchema = mongoose.Schema({
    // réalisation des données du Schéma
    titre: {
        type: String,
        //required: true
    },
...
myRouter.route('/').all(function (req, res) {
    res.json({
        message: "Bienvenue sur notre API d'articles",
        methode: req.method,
    }); // retour du message à l'arrivée sur la "home"
});

myRouter
    .route('/articles') // route pour obtenir ma liste d'article, magic !
    ...
    .post(function (req, res) {
        ...
        article.save(function (err) {
            ...
            res.redirect('/index.html'); // redirection vers mon index en guise de réponse grace à express static
        });
    });
...
myRouter
    ...
    // route pour sélectionner un seul article via son ID
    .get(function (req, res) {
